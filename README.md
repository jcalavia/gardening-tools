...
- **Drip Tray** (`drip_tray`) — Rectangular plant drip tray with rounded corners, a sloped floor, flow-guiding ribs, a barbed hose nozzle, and side mounting holes. Tunable length, width, height, wall thickness, slope, drain diameter, barb size, and mount position.
